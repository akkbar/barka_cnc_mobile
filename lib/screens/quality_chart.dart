...
import './quality_chart/line_shift_chart.dart';
import './quality_chart/bar_shift_chart.dart';
import './quality_chart/bar_machine_chart.dart';
...
class _TrackQualityScreenState extends State<TrackQualityScreen> {
  ...
  Future<void> fetchPerformanceData() async {
    try {
      ...
      final response = await http.get(Uri.parse('$apiUrl/api/quality?viewBy=$viewBy&dateRange=$selectedDateRange&chartType=$chartType'));
